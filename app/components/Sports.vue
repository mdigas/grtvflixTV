        ...
        <GridLayout columns="50,350,*" rows="auto" >
            ...
            <ScrollView orientation="horizontal" row="0" col="0" colSpan="3" class="stdown1">
                <StackLayout orientation="horizontal" >
                    <GridLayout v-for="(seira, indexs) in sports" rows="200,1" columns="350" class="card" >
                        ...
                        <Button row="1" col="0" :id="index" class="btnDpad" @loaded="elementLoaded($event)" @tap="onItemTap2(indexs)" />
                    </GridLayout>
                </StackLayout>
            </ScrollView>
        </GridLayout> 
